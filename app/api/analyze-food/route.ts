 ...
 *
 * This route acts as a proxy to the FastAPI backend at http://82.153.70.111:8000/analyze-food
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[v0] Forwarding request to FastAPI backend: http://82.153.70.111:8000/analyze-food")

    // Make the request to the FastAPI backend
    const backendResponse = await fetch("http://82.153.70.111:8000/analyze-food", {
      method: "POST",
